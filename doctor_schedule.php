...
<div id="bookingArea" style="max-width:900px;margin:16px auto; display:none;">
  <div class="card">
    ...
    <div class="form-row">
      ...
      <input id="userEmail" class="input" placeholder="Email">
    </div>
    ...
    try {
      ...
      scheduleList.querySelectorAll('.scheduleBtn').forEach(btn => {
        btn.addEventListener('click', (e) => {
          ...
          userName.value = sessionStorage.getItem('appt_user_name') || '';
          userPhone.value = sessionStorage.getItem('appt_user_phone') || '';
          userEmail.value = sessionStorage.getItem('appt_user_email') || '';
